...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Middleware applied to the passkey management routes (create / delete).
    | The package default is ['password.confirm'], but the Filament panels in
    | this app do not register a `password.confirm` named route, which would
    | break passkey registration from the profile page. Left empty on purpose.
    |
    */
